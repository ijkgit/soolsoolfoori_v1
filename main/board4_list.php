...
<div id="bbox">
	<h1>TOP Seller</h1>
	<div id="photo_box">
		<div id="photo"><a href="board_view.php?num=33&page=1"><img src="./img/new/맥주/세로_랜드마크.jpg"></a></div>
		<div id="photo"><a href="board_view.php?num=32&page=1"><img src="./img/new/맥주/세로_맥비티아이.jpg"></a></div>
		<div id="photo"><a href="board_view.php?num=30&page=1"><img src="./img/new/맥주/세로_제주위트에일.jpg"></a></div>
	</div>
	<div id="hashtag">
	...
	<div id="newbox">
	<h1>NEW!!</h1>
		<div id="newphoto"><a href="board_view.php?num=32&page=1"><img src="./img/new/맥주/가로_맥비티아이.jpg"><h2>맥비티아이</h2></a></div>
		<div id="newphoto"><a href="board_view.php?num=34&page=1"><img src="./img/new/맥주/가로_굿캬와.jpg"><h2>굿캬와</a></h2></div>
		<div id="newphoto"><a href="board_view.php?num=31&page=1"><img src="./img/new3.png"><h2>레츠 프레시 투데이</a></h2></div>
	</div>
...
<?php
	...
	$sql = "select * from board where (category=4) order by num desc";
...
<?php
	...
	{
		$new_page = $page-1;
		echo "<li><a href='board4_list.php?page=$new_page'>◀ 이전</a> </li>";
	}		
	else 
		echo "<li>&nbsp;</li>";
   	...
   	for ($i=1; $i<=$total_page; $i++)
   	{
		...
		{
			echo "<li><a href='board4_list.php?page=$i'> $i </a><li>";
		}
   	}
   	if ($total_page>=2 && $page != $total_page)		
   	{
		$new_page = $page+1;	
		echo "<li> <a href='board4_list.php?page=$new_page'>다음 ▶</a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
			...
			<ul class="buttons">
				<li><button onclick="location.href='board4_list.php'">목록</button></li>
				<li>
<?php 
    if($userid) {
?>
