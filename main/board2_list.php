...
<div id="bbox">
	<h1>TOP Seller</h1>
	<div id="photo_box">
		<div id="photo"><a href="board_view.php?num=19&page=1"><img src="./img/new/소주/세로_화요.jpg"></a></div>
		<div id="photo"><a href="board_view.php?num=20&page=1"><img src="./img/new/소주/세로_서울의밤.jpg"></a></div>
		<div id="photo"><a href="board_view.php?num=21&page=1"><img src="./img/new/소주/세로_일품진로.jpg"></div>
	</div>
	<div id="hashtag">
	...
	<div id="newbox">
	<h1>NEW!!</h1>
		<div id="newphoto"><a href="board_view.php?num=14&page=1"><img src="./img/new1.png"><h2>처음처럼 꿀주</h2></a></div>
		<div id="newphoto"><a href="board_view.php?num=21&page=1"><img src="./img/new/소주/가로_일품진로.jpg"><h2>일품 진로</a></h2></div>
		<div id="newphoto"><a href="board_view.php?num=17&page=1"><img src="./img/jinro-tshirt.png"><h2>진로 X 오베이</a></h2></div>
	</div>
...
<?php
	...
	$sql = "select * from board where (category=2) order by num desc";
...
<?php
	...
	{
		$new_page = $page-1;
		echo "<li><a href='board2_list.php?page=$new_page'>◀ 이전</a> </li>";
	}		
	else 
		echo "<li>&nbsp;</li>";
   	...
   	for ($i=1; $i<=$total_page; $i++)
   	{
		...
		{
			echo "<li><a href='board2_list.php?page=$i'> $i </a><li>";
		}
   	}
   	if ($total_page>=2 && $page != $total_page)		
   	{
		$new_page = $page+1;	
		echo "<li> <a href='board2_list.php?page=$new_page'>다음 ▶</a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
			...
			<ul class="buttons">
				<li><button onclick="location.href='board2_list.php'">목록</button></li>
				<li>
<?php 
    if($userid) {
?>
