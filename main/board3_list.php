...
<div id="bbox">
	<h1>TOP Seller</h1>
	<div id="photo_box">
		<div id="photo"><a href="board_view.php?num=26&page=1"><img src="./img/new/와인/그랑꼬또청수.jpg"></a></div>
		<div id="photo"><a href="board_view.php?num=27&page=1"><img src="./img/new/와인/오미로제결.jpg"></a></div>
		<div id="photo"><a href="board_view.php?num=28&page=1"><img src="./img/new/와인/샤토미소웨딩자두.jpg"></a></div>
	</div>
	<div id="hashtag">
	...
	<div id="newbox">
	<h1>NEW!!</h1>
		<div id="newphoto"><a href="board_view.php?num=28&page=1"><img src="./img/new/소주/샤.png"><h2>샤토미소 웨딩 자두</a></h2></div>
		<div id="newphoto"><a href="board_view.php?num=26&page=1"><img src="./img/new/소주/그1.jpg"><h2>그랑꼬또 청수</a></h2></div>
		<div id="newphoto"><a href="board_view.php?num=27&page=1"><img src="./img/new/소주/결.png"><h2>오미로제 결</a></h2></div>
</div>
<section>
   	<div id="board_box">
	    <h3>
...
<?php
	...
	$sql = "select * from board where (category=3) order by num desc";
...
<?php
	...
	{
		$new_page = $page-1;
		echo "<li><a href='board3_list.php?page=$new_page'>◀ 이전</a> </li>";
	}		
	else 
		echo "<li>&nbsp;</li>";
   	...
   	for ($i=1; $i<=$total_page; $i++)
   	{
		...
		{
			echo "<li><a href='board3_list.php?page=$i'> $i </a><li>";
		}
   	}
   	if ($total_page>=2 && $page != $total_page)		
   	{
		$new_page = $page+1;	
		echo "<li> <a href='board3_list.php?page=$new_page'>다음 ▶</a> </li>";
	}
	else 
		echo "<li>&nbsp;</li>";
?>
			...
			<ul class="buttons">
				<li><button onclick="location.href='board3_list.php'">목록</button></li>
				<li>
<?php 
    if($userid) {
?>
